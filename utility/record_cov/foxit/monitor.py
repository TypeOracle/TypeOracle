...
ADOBE_PATH = r'"C:\Program Files (x86)\Foxit Software\Foxit Reader\FoxitReader.exe"'
CUR_PATH = r'"C:\Users\wxy\TyFuzzer\exp2\record_cov\foxit"'
# CUR_PATH = os.getcwd()
...
class Monitor:
    ...
    def clearDerived(self):
        ...
        list_ = ['FoxitReader.exe', 'WerFault.exe',
